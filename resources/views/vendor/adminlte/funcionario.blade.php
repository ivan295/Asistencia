                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre"
                                value="<?php echo $editar_usuario->name; ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="apellido" id="apellido"
                                value="<?php echo $editar_usuario->apellido; ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="consult_edificio" onchange="consultar_edificio()">
                                    ...
                                    <option value="<?php  echo $edificio->id ; ?>">
                                        <?php echo $edificio->descripcion; ?> </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        @elseif(Auth::user()->id_tipouser == 3 || Auth::user()->id_tipouser == 4)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="input" disabled class="form-control" name="email" id="email"
                                        value="<?php echo $editar_usuario->email; ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
