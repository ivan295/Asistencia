...
<br>
<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#newdepartment"><span class="glyphicon glyphicon-plus"></span> Crear nuevo Departamento</button>
<form method="post"  action="/departamento_create">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
  <div class="modal fade" id="newdepartment" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h3 class="modal-title text-center">Crear nuevo Departamento</h3>
      </div>
        ...
        <div class="box-body">
          <div class="col-md-12">
           ...
           <div class="input-group">
           	  ...
           	  <input type="text" class="form-control" name="departamento" id="departamento" placeholder="Nombre del departamento" required>
                 @error('departamento')
